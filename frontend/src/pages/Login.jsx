...
export default function Login() {
      ...
      <div style={styles.leftPanel}>
        <div style={styles.leftContent}>
          ...
          <div style={styles.statsRow}>
            ...
            <div style={styles.statBox}>
              <span style={styles.statNum}>ERP</span>
      ...
      <div style={styles.rightPanel}>
        <div style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <p style={styles.cardSubtitle}>Système de Gestion ERP • Cardage</p>
          </div>
  ...
  /* FIX couleur jaune (Chrome autofill) */
...
const styles = {
  ...
  button: {
    ...
    ":hover": {
      ...
      boxShadow: "0 8px 20px rgba(26,44,78,0.25)",
    },
  },
  buttonLoading: {
    opacity: 0.75,
